...
Read only decisions relevant to the task after the [protocol](../../development/REQRO_CODEX_PROTOCOL.md), [Architecture](../../ARCHITECTURE.md) and [Roadmap](../../ROADMAP.md). These concise ADRs consolidate accepted behavior through F041; they do not introduce a feature, grant permissions or approve deployment.
