...
Reqro is a client-neutral resident-engagement and staff-work platform. This is the current system map through F042, with the locally validated F043 presentation consolidation; its [implementation report](features/F042-implementation-report.md) records validation and the approved two-record UAT automation exception. Historical CityVUE identifiers remain in code and deployment configuration. The [development protocol](development/REQRO_CODEX_PROTOCOL.md) governs execution, [ADRs](architecture/decisions/README.md) explain durable decisions, [feature records](features/README.md) retain implementation evidence, and the [roadmap](ROADMAP.md) separates future work. Code/tests/database remain authoritative; investigate conflicts before changing behavior.
...
Production identity activation, resident-safe history, externally delivered requester communication, notifications, attachments, administration, retention/redaction, integration reliability and production-volume performance remain reviewed future work. See [Roadmap](ROADMAP.md); F043 is locally complete pending review; F044 has not been selected or started.
