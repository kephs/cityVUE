...
export default function ServiceRequestDetailsPage({ data: suppliedData }) {
    ...
    return <article className="service-request-details">
        ...
        <div className="request-details-grid">
            ...
            <Panel title="Requester" icon="bi-person"><p className="details-prose">{details.requester.anonymous ? "Anonymous" : "Protected"}</p><p>Requester contact requires separate permission and is unavailable in this view.</p></Panel>
