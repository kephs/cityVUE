...
const ReportIssuePage = lazy(
  () => import("../pages/report/ReportIssuePage.jsx"),
);
const ServiceRequestDetailsPage = lazy(
  () => import("../pages/issues/ServiceRequestDetailsPage.jsx"),
);
...
function redirectLegacyReport({ request }) {
  ...
  return redirect(
    issueId ? `/issues/${encodeURIComponent(issueId)}/edit` : "/report",
  );
}
...
const router = createBrowserRouter([
  ...
  },
  {
    path: "/admin-preview",
    element: (
      <Suspense fallback={<p role="status">Loading admin preview…</p>}>
        <AdminPreviewPage />
      </Suspense>
    ),
  },
